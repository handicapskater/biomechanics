menuData = [
        ...
        { name: 'com-platform', url: '/platform.html', text: '.com Platform' },
        { name: 'org-standards', url: '/standards.html', text: '.org Standards' },
        { name: 'legacy-site', url: '/index.htm', text: 'Legacy Site' },
]
