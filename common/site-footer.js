(function () {
  ...
  // The homepage contact content is the canonical shared .com footer.
...
<footer class="site-footer home-contact-footer" aria-label="Contact and support">
  <div class="home-footer-inner">
    ...
    <nav class="home-footer-social" aria-label="Connect with HandicapSkater on social media">
      ...
      <a href="https://twitter.com/handicapskater" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter" title="X / Twitter">
        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://www.linkedin.com/company/103320223/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="LinkedIn">
      ...
      <a href="https://www.youtube.com/channel/UCv8NPazTzuPxE_YM8-MIReQ" target="_blank" rel="noopener noreferrer" aria-label="YouTube" title="YouTube">
        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
        height="24"
      ...
      <a href="https://rumble.com/c/c-1635644" target="_blank" rel="noopener noreferrer" aria-label="Rumble" title="Rumble">
        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
        height="24"
      ...
      <a href="https://instagram.com/handicapskater" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram">
        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
        height="24"
